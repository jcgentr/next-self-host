  ...
  return (
    <section>
      ...
      <p>
        ...
        <a href="https://github.com/jcgentr/next-self-host">View the code</a>.
      </p>
      ...
      <p>
        ...
        <a href="https://github.com/jcgentr/next-self-host/blob/main/image-loader.ts">
          here
        </a>
        , which you can enable through{" "}
        <a href="https://github.com/jcgentr/next-self-host/blob/main/next.config.ts">
